defmodule BotArmyGithub.Skills.Example do
  @moduledoc """
  Example skill for GitHub Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_github.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_github.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_github/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_github.command.example"
    ]
  end
