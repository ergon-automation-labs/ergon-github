defmodule BotArmyGithub.HTTPClient do
  @moduledoc """
  ...
  Pass http_client as an option in init:
      def init(opts) do
        http_client = Keyword.get(opts, :http_client, BotArmyGithub.HTTPClient.Req)
...
defmodule BotArmyGithub.HTTPClient.Req do
  @moduledoc """
  Real HTTP client implementation using the Req library.
  """

  @behaviour BotArmyGithub.HTTPClient
