defmodule BotArmyGithub.PulsePublisher do
  @moduledoc """
  Periodic health publisher for GitHub Bot.
  ...
  2. **`bot.github.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @service_name "github"
  @envelope_source "bot_army_github"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting GitHub Bot pulse publisher")
