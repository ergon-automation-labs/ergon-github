defmodule BotArmyGithub.ExampleTest do
  @moduledoc """
  ...
  describe "module initialization" do
    test "application starts without errors" do
      assert BotArmyGithub.Application != nil
    end
  end
  ...
  describe "pulse publisher" do
    test "pulse publisher module exists" do
      ...
      assert module_exists?(BotArmyGithub.PulsePublisher)
    end
  end
  ...
  describe "http client behavior" do
    test "http client behavior is defined" do
      ...
      assert module_exists?(BotArmyGithub.HTTPClient)
      assert module_exists?(BotArmyGithub.HTTPClient.Req)
    end
  end
